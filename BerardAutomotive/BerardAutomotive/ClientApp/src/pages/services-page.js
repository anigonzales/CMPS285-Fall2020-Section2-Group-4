        ...
        <Tab.Pane>
            <h1> Brake Inspection System</h1>
                            <p> At MIKES AUTOMOTIVE in Mandeville, La. all brake systems are diagnosed and tested by ASE-master
                                certified technician Mike Levytskyi. Mike has been servicing automobiles since 2000. Over the last 20
                                years Mike has performed thousand’s of brake jobs. He will test and diagnose your brake system problem
                            ...
                            <ul style={{"textAlign": "center", "display" : "inline", "list-style-type": "none"}}>
    ...
    { menuItem: 'Batteries/ Starters/ Alternators', render: () => 
        <Tab.Pane>
            <h1>Battery Service and Repair</h1>
                <p>
                    At MIKES AUTOMOTIVE in Mandeville, La., we service/repair/replace batteries, starters, and alternators.
                    Diagnosis and testing is preformed by ASE-master certified technician Mike Levytskyi. If any service or repair
    ...
    { menuItem: 'Alignment/ Wheel Balance', render: () => 
        <Tab.Pane>
           <h1> Alignment Service and Repair </h1>
            ...
            <p>AT MIKES AUTOMOTIVE on Girod street in Old Mandeville, La. all wheel alignments are performed by ASE-Master
            Certified Technician Mike Levytskyi or one of his ASE-certified technicians. Mike has been working on automobiles since 2000;
            opening MIKE’S AUTOMOTIVE on Girod st. in Mandeville, La. in 2010. He started his career as an alignment specialist,
            performing thousands of alignments through the years. We can check to see if you need an alignment before its performed,
            often the alignment is O.K. Surprisingly a tire low on air pressure or out of balance can be the problem. </p>
            ...
            <p> <b>All of these can add up and eventually cause your vehicle to be out of alignment.</b></p>

            <p> <b>We measure each wheel’s angle and alignment, that measurement is taken and compared to factory specification.
    ...
    { menuItem: 'Air Conditioning Service and Repair', render: () => 
        <Tab.Pane>
            ...
            <p>At MIKES AUTOMOTIVE in Mandeville, La. all A/C systems are diagnosed and tested by ASE-master certified
                technician Mike Levytskyi. He has also completed training and testing through EPA-approved A/C programs. Mike
                has been working on automobiles since 2000; opening MIKE’S AUTOMOTIVE at 723 Girod street, Old Mandeville,
                in 2010. We have repaired thousand’s of air conditioning systems over the years. He will test and diagnose
            ...
            <p><b>The number one problem we find is low refrigerant. Over time A/C O-rings, hoses and seals wear out – and

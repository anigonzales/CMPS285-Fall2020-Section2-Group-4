...
const panes = [
    { menuItem: 'Brake Service and Repair', render: () => 
        <Tab.Pane>
            <div className= 'services1'>
                ...
                <p style ={{'textAlign': 'left', 'float': 'left'}}><img src = {servicesBrake} height="150px" width="170px" hspace="20" alt=""/> 
                </p>
    ...
    { menuItem: 'Alignment/ Wheel Balance', render: () => 
        <Tab.Pane>
            ...
            Certified Technician Mike Levytskyi or one of his ASE-certified technicians. He started his career as an alignment specialist,
    ...
    { menuItem: 'Air Conditioning Service and Repair', render: () => 
        <Tab.Pane>
            ...
            <p>
            At MIKES AUTOMOTIVE in Mandeville, La. all A/C systems are diagnosed and tested by ASE-master certified
                technician Mike Levytskyi. He has also completed training and testing through EPA-approved A/C programs. 
                We have repaired thousand’s of air conditioning systems over the years. He will test and diagnose
